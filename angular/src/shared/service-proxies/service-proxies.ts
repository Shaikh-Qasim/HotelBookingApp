...
export class HotelServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<HotelDto> {
    ...
    protected processGet(response: HttpResponseBase): Observable<HotelDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<HotelDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<HotelDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<HotelDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<HotelDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<HotelDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: HotelDto | undefined): Observable<HotelDto> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<HotelDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: HotelDto | undefined): Observable<HotelDto> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<HotelDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
