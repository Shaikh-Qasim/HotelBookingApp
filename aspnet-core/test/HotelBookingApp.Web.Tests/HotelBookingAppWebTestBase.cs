...
{
    public abstract class HotelBookingAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HotelBookingAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HotelBookingAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HotelBookingAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HotelBookingAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HotelBookingAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HotelBookingAppDbContext, Task<T>> func)
        {
            T result;
